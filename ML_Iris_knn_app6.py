...
def MarvellousKNeighbor():
    ...
    data_train,data_test,target_train,target_test = train_test_split(data,target,test_size=0.5) # 0.5 means 50 - 50 data splited for testing and traing by shuffeling data
